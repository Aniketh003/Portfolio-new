  ...
  return (
    <div className='tectStack' >
      ...
      <div className="coding">
        <a href="https://leetcode.com/Aniketh03/" target="_blank"><div className="card">
        ...
        <a href="https://www.hackerrank.com/anikethbusavale1" target="_blank"><div className="card">
        ...
        <a href="https://auth.geeksforgeeks.org/user/aniketh03/practice" target="_blank"><div className="card">
