  ...
  return (
    <div className='tectStack' >
      ...
      <div className="coding">
        <a href="https://leetcode.com/Aniketh03/" target="_blank" rel="noreferrer"><div className="card">
          ...
          <div className="description">
            <h3>Leetcode</h3>
            <p>Solved 100+ questions</p>
          </div>
        </div></a>
        <a href="https://www.hackerrank.com/anikethbusavale1" rel="noreferrer" target="_blank"><div className="card">
        <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fgdm-catalog-fmapi-prod.imgix.net%2FProductLogo%2F8b9fc1fa-bb42-45c6-957b-3b6611c542f1.png%3Fixlib%3Dreact-9.0.3%26ch%3DWidth%252CDPR%26auto%3Dformat%26w%3D4088&f=1&nofb=1&ipt=f697dbc19a00717403620013df9d33efeefcb75f9d03d60034aa467a59c10c30&ipo=images" alt="Hackerrank logo" />
          <div className="description">
            <h3>Hackerrank</h3>
            <p>Achived 5 star in C++</p>
          </div>
        </div></a>
        <a href="https://auth.geeksforgeeks.org/user/aniketh03/practice" target="_blank" rel="noreferrer"><div className="card">
